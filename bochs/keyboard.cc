/////////////////////////////////////////////////////////////////////////
// $Id: keyboard.cc,v 1.1 2006/12/04 03:19:51 jcomeau_ictx Exp $
/////////////////////////////////////////////////////////////////////////
//
...
{
  BX_DEBUG(("Init $Id: keyboard.cc,v 1.1 2006/12/04 03:19:51 jcomeau_ictx Exp $"));
  Bit32u   i;
  ...
  DEV_register_iowrite_handler(this, write_handler,
                                      0x0064, "8042 Keyboard controller", 1);
  DEV_register_iowrite_handler(this, cf_debug,
                                      0x00e1, "custom debug hardware", 1);
...
// debug port, does nothing except generate message in log
// for debugging colorForth and anything else that uses port 0xe1
void bx_keyb_c::cf_debug(void *this_ptr, Bit32u address, Bit32u value, unsigned io_len)
{
 BX_DEBUG(("cf_debug: byte is 0x%02x", value));
}
